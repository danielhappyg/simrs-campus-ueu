...
class G0GovernanceV2ImplementationBlueprintTest < Minitest::Test
  ...
  CURRENT_V2_GOVERNANCE_TESTS = %w[
    ...
    tests/Documentation/G0GovernanceV2ExternalTrustProvisioningProposalTest.rb
    tests/Documentation/G0GovernanceV2GateBEvidenceTest.rb
    tests/Documentation/G0GovernanceV2HostTrustBoundaryApprovalDecisionDraftTest.rb
    tests/Documentation/G0GovernanceV2HostTrustBoundaryArchitectureDecisionTest.rb
    ...
    tests/Documentation/G0GovernanceV2ProcessSimplificationDecisionTest.rb
