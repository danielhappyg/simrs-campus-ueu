 ...
 */
class FinanceRadiologyTariffBindingVersion extends Model
{
    ...
    protected static function booted(): void
    {
        static::creating(static function (self $version): void {
            ...
            if ($version->version < 1 || ! in_array($version->state, [FinanceRadiologyTariffBinding::ACTIVE, FinanceRadiologyTariffBinding::RETIRED], true)) {
                throw new LogicException('Radiology tariff binding version evidence is invalid.');
            }
        });
        static::updating(static fn () => throw new LogicException('Radiology tariff binding versions are immutable.'));
        static::deleting(static fn () => throw new LogicException('Radiology tariff binding versions cannot be deleted.'));
    }

    /** @return BelongsTo<FinanceRadiologyTariffBinding, $this> */
    public function binding(): BelongsTo
    {
        return $this->belongsTo(FinanceRadiologyTariffBinding::class, 'binding_id');
    }
