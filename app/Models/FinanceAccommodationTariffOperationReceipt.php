 ...
 */
class FinanceAccommodationTariffOperationReceipt extends Model
{
    ...
    protected static function booted(): void
    {
        static::creating(static function (self $receipt): void {
            ...
            if ($receipt->result_type !== self::RESULT_BINDING || $receipt->result_version < 1
                ...
                throw new LogicException('Accommodation tariff binding receipt evidence is incomplete.');
            }
        });
        static::updating(static fn () => throw new LogicException('Accommodation tariff binding receipts are immutable.'));
        static::deleting(static fn () => throw new LogicException('Accommodation tariff binding receipts cannot be deleted.'));
    }
