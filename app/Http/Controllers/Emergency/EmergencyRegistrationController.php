...
class EmergencyRegistrationController extends Controller
{
    ...
    private function storeRegistration(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'admission_mode' => ['required', Rule::in(Encounter::EMERGENCY_ADMISSION_VALUES)],
            ...
            'case_type' => ['required', Rule::in(Encounter::CASE_TYPE_VALUES)],
            'accident_type' => ['required', Rule::in(Encounter::ACCIDENT_TYPE_VALUES)],
