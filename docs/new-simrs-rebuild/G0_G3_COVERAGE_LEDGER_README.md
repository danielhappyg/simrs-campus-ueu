...
That first schema-v2 artifact is now an immutable observation bound to validator contract 1.0.0. The create-only [`G0_G3_COVERAGE_LEDGER_V2_2026-08-29_R2.json`](G0_G3_COVERAGE_LEDGER_V2_2026-08-29_R2.json) successor is bound to validator contract 1.2.0. The retained R3 through [`G0_G3_COVERAGE_LEDGER_V2_2026-09-03_R11.json`](G0_G3_COVERAGE_LEDGER_V2_2026-09-03_R11.json) successors remain immutable observations. The create-only [`G0_G3_COVERAGE_LEDGER_V2_2026-09-03_R12.json`](G0_G3_COVERAGE_LEDGER_V2_2026-09-03_R12.json) successor is the current binding-refreshed schema-v2 local observation and binds the R10 cashier-collection engineering-evidence map. Every predecessor remains immutable historical evidence and is not rewritten or reinterpreted by R12.
...
- [`G0_G3_COVERAGE_EVIDENCE_MAP_V2_2026-09-03_R9.json`](G0_G3_COVERAGE_EVIDENCE_MAP_V2_2026-09-03_R9.json) is the immutable cashier-collection engineering-evidence predecessor. Its artifact ID is `COVERAGE-ENGINEERING-EVIDENCE-MAP-V2-2026-09-03-R9`, its exact SHA-256 is `f8785833c7259a798b0185938e6e45c15c1ec3c7e8c7efe46b2d27038f9f84dc`, and it binds exact R8 bytes plus the bounded cashier-collection catalogue, final evidence record, and two exact disposable-engine artifacts.
- [`G0_G3_COVERAGE_EVIDENCE_MAP_V2_2026-09-03_R10.json`](G0_G3_COVERAGE_EVIDENCE_MAP_V2_2026-09-03_R10.json) is the current binding-refreshed local engineering-evidence map. Its artifact ID is `COVERAGE-ENGINEERING-EVIDENCE-MAP-V2-2026-09-03-R10`, its exact SHA-256 is `36206930991317baa9ca7fd9c10e79a05c82c6aa931c0817d02b37b565f02201`, and it binds exact R9 bytes while preserving the cashier evidence-path catalogue and refreshing only current allowed source-byte bindings.
...
- [`G0_G3_COVERAGE_LEDGER_V2_2026-09-03_R11.json`](G0_G3_COVERAGE_LEDGER_V2_2026-09-03_R11.json) is the immutable cashier-collection observation predecessor. Its artifact ID is `G0-G3-COVERAGE-LEDGER-V2-2026-09-03-R11`, its exact SHA-256 is `aedb8ec542b9aeb8111d9877b3355f21d04f5f48adcd3572cdadb95fe5ed0452`, and it binds exact R10 and R9 bytes while preserving every governance, authority, owner, hosted, deployment, G0, and G3 fact.
- [`G0_G3_COVERAGE_LEDGER_V2_2026-09-03_R12.json`](G0_G3_COVERAGE_LEDGER_V2_2026-09-03_R12.json) is the current binding-refreshed schema-v2 local observation. Its artifact ID is `G0-G3-COVERAGE-LEDGER-V2-2026-09-03-R12`, its exact SHA-256 is `cf4e12d47ec9b016c0de2e3cfd5bcc7f8448cbb20b317ac61478b98117dfd3f6`, and it binds exact R11 and R10 bytes while preserving every governance, authority, owner, hosted, deployment, G0, and G3 fact.
...
- [`scripts/generate-g0-g3-coverage-cashier-collection-successors.rb`](../../scripts/generate-g0-g3-coverage-cashier-collection-successors.rb) is the historical successor-specific create-only publisher for the immutable R9 map and R11 ledger. Its fixed output checks now validate those historical bytes directly instead of recomputing them from later source; it cannot mutate governance selection, implementation authority, completion state, or gates.
- [`scripts/generate-g0-g3-coverage-cashier-collection-binding-refresh-successors.rb`](../../scripts/generate-g0-g3-coverage-cashier-collection-binding-refresh-successors.rb) is the create-only publisher for the current R10 map and R12 ledger. It binds exact immutable R9/R11 predecessors, keeps the R9 cashier evidence-path catalogue unchanged, refreshes only current allowed source hashes and the final-record hash, rejects overwrites, and cannot mutate governance selection, authority, status, acceptance, G0, or G3.
...
ruby scripts/generate-g0-g3-coverage-cashier-collection-binding-refresh-successors.rb --kind map --check
ruby scripts/generate-g0-g3-coverage-cashier-collection-binding-refresh-successors.rb --kind ledger --check
...
ruby tests/Documentation/G0G3CoverageCashierCollectionBindingRefreshSuccessorsTest.rb
```

The original schema-v2 check still proves the exact deterministic historical R4 ledger bytes and selector-bound observation contract. The successor checks prove exact immutable predecessor bytes through R9/R11, current R10/R12 bytes, predecessor immutability, bounded accommodation, settlement, cash-correction, cashier-collection engineering deltas, current allowed source bindings, and unchanged fail-closed governance. All publisher generations are create-only and refuse to overwrite an existing artifact. No publisher can establish owner acceptance, hosted readiness, deployment, G0, or G3.
