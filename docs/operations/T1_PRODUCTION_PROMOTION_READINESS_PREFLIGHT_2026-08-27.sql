...
WITH expected_ledger(id, migration, batch) AS (
    ...
    SELECT NOT EXISTS (
               ...
               WHERE schema_row.nspname = 'laravel'
                 AND (
                     relation_row.relname ~ '^(break_glass_|security_ledger_|daily_queue_counters|teaching_role_access_leases)'
       ...
       AND NOT EXISTS (
               ...
               WHERE schema_row.nspname = 'laravel'
                 AND (
                     ...
                     OR constraint_row.conname ~ '^(break_glass_|security_ledger_|daily_queue_counters_|teaching_role_access_leases_)'
