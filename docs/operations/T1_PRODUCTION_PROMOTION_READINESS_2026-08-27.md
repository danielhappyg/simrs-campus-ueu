...
**Candidate state:** `EXACT_COMMITTED_RELEASE_CANDIDATE`; runtime/application commit `c668cdc4434ac7a2958510b1511d6b1c431e8190`
...
GitHub `main` and the public Vercel Production alias are separate release controls. The runtime/application candidate is now frozen at `c668cdc4434ac7a2958510b1511d6b1c431e8190`; the following evidence-only control commit records that parent SHA before the pair is pushed once. Vercel does not run the Laravel migrations against Supabase. Promoting a Preview while the shared database remains on its older schema could expose code paths whose required tables, columns, indexes, foreign keys, queue allocator, and teaching-access fencing do not exist.
...
The sanitized [current result](T1_PRODUCTION_PROMOTION_READINESS_RESULT_2026-08-27.json) is bound to Supabase project ref `xbmsfvstcpngizcplqyg`, capture time `2026-08-27T05:26:52.049385Z`, query SHA-256 `a70ff74908a6eac5bf04f5313f38f5abf0f8985b9cd56d91cfdfdae77a1a6d4c`, and result-file SHA-256 `8564d3bc4252706690c6a1b6b15dedf1041e927552baae9c98d6a81854d31be1`. Its status is `PRE_MIGRATION_CONTRACT_MATCH`, `candidate_state` is `EXACT_COMMITTED_RELEASE_CANDIDATE`, `candidate_application_sha` is `c668cdc4434ac7a2958510b1511d6b1c431e8190`, and `promotion_authorized` remains `false`.
