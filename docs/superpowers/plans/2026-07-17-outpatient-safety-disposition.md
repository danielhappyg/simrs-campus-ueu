...
- [ ] **Step 3: Implement the migration, enum labels, relations, casts, and append-only model guards**
...
- [ ] **Step 1: Add failing task, authorization, outcome, idempotency, audit, and rollback tests**
...
- [ ] **Step 3: Add the narrow capability and task type to reference assignments**
...
- [ ] **Step 4: Create disposition tasks when the nursing escalation is approved**
...
- [ ] **Step 5: Implement the transactional disposition service**
...
- [ ] **Step 1: Write failing route, payload, denial, privacy, and work-queue tests**
...
- [ ] **Step 3: Implement the dedicated resolver, request, controllers, routes, and queue mapping**
...
- [ ] **Step 4: Generate Wayfinder routes and verify GREEN**
...
- [ ] **Step 3: Implement the accessible UEU interface**
...
- [ ] **Step 4: Run focused React, axe, TypeScript, and backend tests and verify GREEN**
...
- [ ] **Step 2: Browser-validate a fresh escalated synthetic fixture**
